		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					...
					<label><input type="checkbox" name="<?php echo TWL_CORE_OPTION; ?>[url_shorten_bitly]" value="1" class="url-shorten-bitly-checkbox" <?php checked( $options['url_shorten_bitly'], '1', true ); ?> /> <?php _e( 'Shorten URLs using Bit.ly', TWL_TD ); ?></label><br />
					<input size="50" type="text" name="<?php echo TWL_CORE_OPTION; ?>[url_shorten_bitly_token]" placeholder="<?php _e( 'Enter Bit.ly Access Token', TWL_TD ); ?>" value="<?php echo htmlspecialchars( $options['url_shorten_bitly_token'] ); ?>" class="regular-text url-shorten-bitly-key-text" style="display:block;" />
					<small><?php _e( 'Shorten all URLs in the message using the <a href="https://code.google.com/apis/console/" target="_blank">Bit.ly URL Shortener API</a>. Checking will display the access token field.', TWL_TD ); ?></small><br /><br />
					<label><input type="checkbox" name="<?php echo TWL_CORE_OPTION; ?>[url_shorten]" value="1" class="url-shorten-checkbox" <?php checked( $options['url_shorten'], '1', true ); ?> /> <?php _e( 'Shorten URLs using Google (Deprecated)', TWL_TD ); ?></label><br />
